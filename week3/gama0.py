#思路： (NETCASHLYR/Mean(NETASSET,20)-Mean(NETCASHLYR/Mean(NETASSET,20),600))/Std(NETCASHLYR/Mean(NETASSET,20),600)
#!/usr/bin/env Python
# -*- coding:utf-8 -*-
# author: mqh
import time
...
class Factor(FactorBase):
	def __init__(self):
		...
		self.needFields = [t.NETCASHLYR,t.NETASSET]
	def factor_definition(self):
		s = time.time()
		needData = self.needData
		element=needData[t.NETCASHLYR]
