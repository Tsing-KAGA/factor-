#思路： (OPERREVLYR/Mean(NETASSET,20)-Mean(OPERREVLYR/Mean(NETASSET,20),600))/Std(OPERREVLYR/Mean(NETASSET,20),600)
#!/usr/bin/env Python
# -*- coding:utf-8 -*-
# author: mqh
import time
...
class Factor(FactorBase):
	def __init__(self):
		...
		self.needFields = [t.OPERREVLYR,t.NETASSET]
	def factor_definition(self):
		s = time.time()
		needData = self.needData
		element=needData[t.OPERREVLYR]
