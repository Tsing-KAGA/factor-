#思路： (NETCAHLYR/Mean(NETASSET,20)-Mean(NETCAHLYR/Mean(NETASSET,20),600))/Std(NETCAHLYR/Mean(NETASSET,20),600)
#!/usr/bin/env Python
# -*- coding:utf-8 -*-
# author: mqh
import time
...
class Factor(FactorBase):
	def __init__(self):
		...
		self.needFields = [t.NETCAHLYR,t.NETASSET]
	def factor_definition(self):
		s = time.time()
		needData = self.needData
		element=needData[t.NETCAHLYR]
